...
BDD reordering with sifting: from 4893 to ... 3549 nodes in 0 sec
...
Number of inputs = 60
BDD reordering with sifting: from 6204 to ... 4623 nodes in 0.01 sec
New order
...
Number of cache look-ups: 59178
Number of cache hits: 28643
Number of cache insertions: 30614
Number of cache collisions: 2550
Number of cache deletions: 28064
Cache used slots = 18.07% (expected 0.00%)
Soft limit for cache size: 62464
Number of buckets in unique table: 15616
Used buckets in unique table: 21.05% (expected 20.96%)
...
Maximum resident size            =  6388K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1629
Swaps = 0
Input blocks = 0
Output blocks = 8
