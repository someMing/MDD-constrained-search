...
@@BDD reordering with sifting: from 1443 to ... 847 nodes in 0 sec
...
@@@@BDD reordering with sifting: from 1877 to ... 1013 nodes in 0 sec
...
Maximum resident size            =  6280K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1549
Swaps = 0
Input blocks = 0
Output blocks = 16
